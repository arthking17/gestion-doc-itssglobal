      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="profil.png" class="user-image" alt="User Image">
    ...
    <section class="content">
      ...
      <div class="col-lg-3 col-xs-6">
          ...
          <div class="<?PHP echo $couleur[$i] ?>">
            ...
            <?PHP
              ...
              {
                $_SESSION['iddossier']=$_GET['dossier'];
                echo "<a class='small-box-footer' href='supprimerDossier.php?dossier=".$rowd['id']."' style='color:red'>supprimer <img src='mini_delete.png' alt='delete'/></a>";
              }
              if($_SESSION['type'] == 1)
              {
      ...
      <div class="row">
          <?PHP
            ...
            echo "<a href='' onclick=\"open('".$fichier['url']."', 'Popup', 'scrollbars=1,resizable=1,height=720,width=720'); return false;\"><img src='expand.png' alt='agrandir'/></a>";
          ?>
          <a class="small-box-footer" href="supprimerFichier.php?fichier=<?PHP echo $fichier['id']; $_SESSION['iddossier']=$_GET['dossier']?>" style="color:red"><img src="delete.png" alt="delete"/></a>
      </div>
      <?PHP
            }
          ?>
