...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- search form -->
      <form action="gestionAcces.php" method="GET" class="sidebar-form">
        <div class="input-group">
        <select name="login" id ="login" class="form-control select2" style="width: 100%; height: 100%">
          <?PHP $simple_user = $userc->recupererUser_type('2');
          foreach($simple_user as $row)
          { ?>
            <option value="<?PHP echo $row['login']; ?>" ><?PHP echo $row['nom'] ?> </option>
            <?PHP 
          }
          ?>
        </select>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Accès
        <small>aux dossiers de <?PHP if(isset($_GET['login'])) echo $_GET['login'] ?></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Accueil</a></li>
        <li class="active">Gestion de l'accès</li>
      </ol>
    </section>
                ...
                <div class="table100 ver1 m-b-110">
					<table data-vertable="ver1">
                        ...
                        <?PHP 
                            if(isset($_GET['login'])) 
                            {
                                $acces = $userc->recupererAcces($_GET['login']);
