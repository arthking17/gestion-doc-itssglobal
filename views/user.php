    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?PHP if($_SESSION['profil']==NULL) echo "uploads/profil.png"; else echo $_SESSION['profil']; ?>" class="img-circle" alt="User Image">
        </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Listes d'utilisateur</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tableau d'utilisateur</h3>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><?PHP echo $user['datei'] ?></td>
                  <td><span class="<?PHP if($user['type']==1) echo "label label-danger"; else if($user['type']==2) echo "label label-success"; ?>"><?PHP if($user['type']==1) echo "administrateur"; else if($user['type']==2) echo "simple utilisateur"; ?></span></td>
