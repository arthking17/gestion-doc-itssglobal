...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><img src="https://www.itssglobal.com/wp-content/uploads/2019/02/LOGO_ITSSGLOBAL-1.png" alt="ITSS Global"></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="profil.png" class="img-circle" alt="User Image">
        </div>
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="<?PHP echo $_SESSION['profil']?>" alt="User profile picture">

              <h3 class="profile-username text-center"><?PHP echo $_SESSION['nom'] ?></h3>

              <p class="text-muted text-center"><?PHP if($_SESSION['type'] == 1) echo "administrateur"; else echo "simple utilisateur" ?></p>

              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Login</b> <a class="pull-right"><?PHP echo $_SESSION['login'] ?></a>
                </li>
                <li class="list-group-item">
                  <b>Email</b> <a class="pull-right"><?PHP echo $_SESSION['email'] ?></a>
                </li>
                <li class="list-group-item">
                  <b>Date de création du compte</b> <a class="pull-right"><?PHP echo $_SESSION['date'] ?></a>
                </li>
              </ul>
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="settings">
                <form class="form-horizontal" action="editProfil.php" method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="password" class="form-control" id="AN_mdp" name="AN_mdp" placeholder="Mot de passe">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="inputName" class="col-sm-2 control-label">Mot de passe de confirmation</label>

                    <div class="col-sm-10">
                      <input type="password" class="form-control" id="mdp_confirmation" name="mdp_confirmation" placeholder="Mot de passe de confirmation">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <button type="submit" class="btn btn-danger" name="edit" id="edit">Submit</button>
                    </div>
                  </div>
                </form>
              </div>
