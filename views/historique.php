...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- search form -->
      <form action="historique.php" method="get" class="sidebar-form">
        <div class="input-group">
            <input type="text" name="search" class="form-control" placeholder="Recherche..." value="<?PHP if(isset($_GET['search'])) echo $_GET['search']; else echo ""; ?>">
            <div class="input-group date" data-provide="datepicker">
            <input type="text" class="form-control" name="date_search" value="<?PHP if(isset($_GET['date_search'])) echo $_GET['date_search']; else echo ""; ?>" placeholder="Recherche...">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Historiques de consultation des documents et fichiers
        <small></small>
      </h1>
      <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="box-footer box-comments">
            <?PHP 
                ...
                if(isset($search) && isset($date_search)){
                    $historique = $dossierC1->recupererHistorique($search, $date_search);
                }else if(isset($_GET['search_id']))
                    $historique = $dossierC1->recupererHistoriqueId($_GET['search_id']);
                else
                    $historique = $dossierC1->recupererHistorique("", "");
                foreach($historique as $hist){
            ?>
            <div class="box-comment">
                <!-- User image -->
                <img class="img-circle img-sm" src="<?PHP echo $hist['profil']; ?>" alt="User Image">

                <div class="comment-text">
                      <span class="username">
                        <?PHP echo $hist['nom_user'] ?>
                        <span class="text-muted pull-right"><?PHP echo $hist['date_modif'] ?></span>
                      </span><!-- /.username -->
                      <?PHP if($hist['type_obj']=='dossier'){
                                if($hist['type_modif']=='ajouter'){
                                    echo "a ajouté un nouveau dossier de nom <b> ".$hist['nom']."</b> d'adresse <b>".$hist['adresse']."</b>";
                                }
                                else if($hist['type_modif']=='renommer'){
                                    echo "a renommé le dossier de nom <b>".$hist['ancien_nom']."</b> et d'adresse <b>".$hist['adresse']."</b> en <b>".$hist['nom']."</b>";
                                }
                                else if($hist['type_modif']=='supprimer'){
                                    echo "a supprimé le dossier de nom <b>".$hist['nom']."</b> d'adresse <b>".$hist['adresse']."</b> ainsi que tous ses fichiers et sous-dossiers";
                                }
                        } else if($hist['type_obj']=='fichier'){
                            if($hist['type_modif']=='ajouter'){
                                echo "a ajouté un nouveau fichier de nom<b> ".$hist['nom']."</b> dans le dossier d'adresse <b>".$hist['adresse']."</b>";
                            }
                            else if($hist['type_modif']=='renommer'){
                                echo "a renommé le fichier de nom <b>".$hist['ancien_nom']."</b> et d'adresse <b>".$hist['adresse']."</b> en <b>".$hist['nom']."</b>";
                            }
                            else if($hist['type_modif']=='supprimer'){
                                echo "a supprimé le fichier de nom <b>".$hist['nom']."</b> d'adresse <b>".$hist['adresse']."</b>";
                            }
                        }
                        ?>
                </div>
