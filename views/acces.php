...
if (isset($_POST['login']) and isset($_POST['valider']) and isset($_SESSION['dossier'])){
    $userc = new UserC();
    $dossierc = new DossierC();
    //isset($_POST['lecture']) and and isset($_POST['ecriture']) and isset($_POST['suppression']) 
    ...
    $suppression = "non";
    if($_POST['droit']=="tous")
      $userc->droitDossier($_SESSION['dossier'], $_POST['login'], $lecture, $ecriture, $suppression);
    else
      $userc->droit($_SESSION['dossier'], $_POST['login'], $lecture, $ecriture, $suppression);
