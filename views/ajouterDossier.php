...
<title>ITSS Global | ajouter un nouveau dossier</title>
...
if (isset($_POST['dossier']) and isset($_POST['add'])){
    $dossier1 = new Dossier($_POST['dossier'], $_SESSION['surdossier']);
    $dossierC1 = new DossierC();
    $dossierC1->ajouterDossier($dossier1);
