            ...
            <div class="col-md-6">
              ...
              <div class="box box-warning direct-chat direct-chat-warning">
                ...
                <div class="box-body">
                  ...
                  <div class="direct-chat-messages">
                    <?PHP
                        ...
                        $message = $userc->recupererMsg($_SESSION['login'], $_GET['receiver']);
                        foreach($message as $msg){
                            if($msg['id_sender']!=$_SESSION['login']){
                    ?>
                    <!-- Message. Default to the left -->
                    <div class="direct-chat-msg">
                      <div class="direct-chat-info clearfix">
                        <span class="direct-chat-name pull-left"><?PHP echo $msg['id_sender'] ; ?></span>
                        <span class="direct-chat-timestamp pull-right"><?PHP echo $msg['date_envoie'] ; ?></span>
                      </div>
                      <!-- /.direct-chat-info -->
                      <img class="direct-chat-img" src="<?PHP echo $msg['profil'] ; ?>" alt="message user image">
                      <!-- /.direct-chat-img -->
                    ...
                    <!-- /.direct-chat-msg -->
                    <?PHP 
                        } else if($msg['id_sender']==$_SESSION['login']){
                        ?>
                    <!-- Message to the right -->
                    <div class="direct-chat-msg right">
                      <div class="direct-chat-info clearfix">
                        <span class="direct-chat-name pull-right"><?PHP echo $msg['id_sender'] ; ?></span>
                        <span class="direct-chat-timestamp pull-left"><?PHP echo $msg['date_envoie'] ; ?></span>
                      </div>
                      <!-- /.direct-chat-info -->
                      <img class="direct-chat-img" src="<?PHP echo $msg['profil'] ; ?>" alt="message user image">
                      <!-- /.direct-chat-img -->
                  ...
                  <div class="direct-chat-contacts">
                    <ul class="contacts-list">
                        <?PHP 
                            $alluser = $userc->recupererAllUser();
                            foreach($alluser as $row){
                        ?>
                      <li>
                        <a href="chat.php?receiver=<?PHP echo $row['login']?>">
                          <img class="contacts-list-img" src="<?PHP echo $row['profil'] ; ?>" alt="User Image">
                          ...
                          <div class="contacts-list-info">
                            ...
                            <span class="contacts-list-msg"><?PHP echo $row['nom'] ; ?></span>
                          </div>
                          <!-- /.contacts-list-info -->
                        </a>
                      </li>
                ...
                <div class="box-footer">
                  <form action="direct-chat.php" method="post">
                    <div class="input-group">
                      <input type="text" name="message" id="message" placeholder="Type Message ..." class="form-control">
                      <span class="input-group-btn">
                            <button type="input" class="btn btn-warning btn-flat" name="send" id="send" >Send</button>
                          </span>
                    </div>
                  </form>
                </div>
